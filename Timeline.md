...
+ ~300 Million AC
  + Novus Divergence — Parcus Stage
    + In cooler vent margins, Mobilis populations diverge into Novus Parcus. Methanogenesis (4H₂ + CO₂ → CH₄ + 2H₂O) emerges as a supplementary metabolism, allowing extended survival during detachment and transit between rock surfaces.
...
+ 0 AC / 0 PC
  + Capture of Xenos
    + Xenos is gravitationally captured into the Procyon system through a three-body interaction, becoming Procyon Ab. Light reaches the planet for the first time, initiating the Photian Era and setting the stage for interaction between Ferrovita and Sulphovita domains.
